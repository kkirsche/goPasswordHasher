...
var md5Cmd = &cobra.Command{
	Use:   "md5",
	Short: "Hashes the text provided into a MD5 password hash.",
	Long:  `Hashes the text provided into a MD5 password hash.`,
	Run: func(cmd *cobra.Command, args []string) {
		hash, err := GenerateMD5FromString(strings.Join(args, " "))
		if err != nil {
			log.Panicln(err)
		}
